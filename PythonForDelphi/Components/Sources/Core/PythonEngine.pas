...
const
{$IFDEF MSWINDOWS}
  PYTHON_KNOWN_VERSIONS: array[1..14] of TPythonVersionProp =
  ( (DllName: 'python23.dll'; RegVersion: '2.3'; APIVersion: 1012; CanUseLatest: True),
    ...
    (DllName: 'python36.dll'; RegVersion: '3.6-32'; APIVersion: 1013; CanUseLatest: True),
    (DllName: 'python36.dll'; RegVersion: '3.6-64'; APIVersion: 1013; CanUseLatest: True) );
{$ENDIF}
{$IFDEF LINUX}
